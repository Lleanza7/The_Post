        ...
        <nav style="position: relative" class="nav2">
            ...
            <div class="centroNav">
                <div class="upNav">
                    ...
                    <form onclick="hideNavMobileSearch()" class="search" method="GET"
                        action="{{ route('article.search') }}">
                        <div onclick="hideNavMobileSearch()" style="display: flex;align-items: center;">
                            @csrf
            ...
            @auth
                <a style="border-right: 0px solid white; display:flex;   align-items: center; margin-top:0px ">
                    ...
                    <form class="formHoverAccount" action="{{ route('logout') }}" id="logout-form" method="POST">
                        @csrf
                        <button style="padding-bottom: 8px" type="submit"><svg xmlns="http://www.w3.org/2000/svg"
                                width="15" height="15" fill="currentColor" class="bi bi-door-open-fill"
                                viewBox="0 0 16 16">
                                <path
        ...
        <div class="centroNav">
            <div class="upNav">
                <div onclick="hideNavMobile()" class="menuMobile">
                    <svg style="cursor:pointer" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                ...
                <form class="search" method="GET" action="{{ route('article.search') }}">
                    <div style="display: flex;align-items: center;">
                        ...
                        <input style="border:0.5px solid black" type="search" aria-label="Search" placeholder="Cerca un articolo" name="query">
                    </div>
                </form>
            </div>
                ...
                @auth
                    <a href="{{ route('logout') }}" style="border-right: 0px solid white;" class="navItem">
                        <form class="formHoverAccount" action="{{ route('logout') }}" id="logout-form" method="POST">
                            @csrf
                            <button type="submit">
                                <svg style="display: block" xmlns="http://www.w3.org/2000/svg" width="20"
                                    height="20" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
                                    <path
                                        d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15zM11 2h.5a.5.5 0 0 1 .5.5V15h-1zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1" />
                                </svg>
                            </button>
