    ...
    <nav class="nav2">
        ...
        <div class="centroNav">
            ...
            <div class="BoxNavItem">
                    ...
                    <div  id="navItem" >
                       ...
                       <div class="handmadeDropdown" >
                        ...
                        @if (Auth::user()->is_revisor)
                                ...
                                <a  href="{{ route('revisor.dashboard') }}">REVISORE</a>
             
                        @endif
                        @if (Auth::user()->is_writer)
                       
                                <a  href="{{ route('writer.dashboard') }}">REDATTORE</a>
                ...
                <a class="navItem" href="{{route('careers')}}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-briefcase-fill" viewBox="0 0 16 16">
                ...
                <a style="border-right: 0px solid white;" class="navItem">
                    <form class="formHoverAccount" action="{{ route('logout') }}" id="logout-form" method="POST">
                        @csrf
                        <button type="submit"><svg style="display: block" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
