@if (session('message'))
    <div style="margin: 0px" id="popSuccess" class="pop" x-data="{ isOpen: true }" x-init="setTimeout(() => { isOpen = false; }, 93000)" >
...
@elseif (session('denied'))
    <div style="margin: 0px" id="popDenied" class="pop" x-data="{ isOpen: true }" x-init="setTimeout(() => { isOpen = false; }, 93000)" >
