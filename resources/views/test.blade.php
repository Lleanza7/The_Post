    ...
    <main>
            ...
            <div  class="boxDivImg">
                <div  class="divImg">
                   <div class="boxDivImgGlass" >
                        <h2>  POLITICA</h2>
                        <p>Tieniti aggiornato sulle ultime novità politiche a livello locale, nazionale e internazionale. Scopri analisi, opinioni e approfondimenti su governi, elezioni, politiche pubbliche e molto altro.
                        </p>
                   </div>
        ...
        <div id="test2" class="test">
            ...
            <div class="boxDivImg">
               ...
               <div class="boxDivImgGlass">
                    <h2>  FINANZA</h2>
                    <p>Rimani al passo con le ultime notizie finanziarie, dai mercati globali agli investimenti personali. Leggi analisi di esperti, tendenze economiche e consigli per gestire al meglio le tue finanze.</p>
               </div>
                </div>
            </div>
        </div>
        ...
        <div style="background-color: #E8ECEF" class="test">
            <div class="boxDivImg">
               ...
               <div class="boxDivImgGlass">
                    <h2> SPORT</h2>
                    <p>Esplora il mondo dello sport con notizie, risultati e analisi delle tue discipline preferite. Dalle competizioni internazionali ai campionati locali, resta informato su tutto ciò che accade nel mondo dello sport.</p>
               </div>
                </div>
            </div>
            <div class="boxCards">
